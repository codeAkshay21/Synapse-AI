    ...
    <Loader loading={loading}>
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-3">
          <SubscriptionCard
            title="STANDARD"
            description="Perfect if you’re just getting started with Synapse AI"
            price="0"
            payment={payment}
          ...
          <SubscriptionCard
            title="PRO"
            description="Perfect if you’re a Freelancer"
            price="15"
            payment={payment}
            onPayment={onSetPayment}
            id="PRO"
          ...
          <SubscriptionCard
            title="ULTIMATE"
            description="Perfect if you’re Organization"
            price="35"
            payment={payment}
            onPayment={onSetPayment}
            id="ULTIMATE"
